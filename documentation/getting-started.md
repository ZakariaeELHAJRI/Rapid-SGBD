...
![Screenshot 1](documentation/images/2.png)
![Screenshot 1](documentation/images/3.png)
...
![Screenshot 1](documentation/images/4.png)

All tables from the database will be imported.

Export Imported Tables:
![Screenshot 1](documentation/images/5.png)
...
**Create New Database:**
![Screenshot 1](documentation/images/6.png)
...
![Screenshot 1](documentation/images/14.png)

Configure application parameters.
![Screenshot 1](documentation/images/15.png)

Access application options and settings.
![Screenshot 1](documentation/images/16.png)
